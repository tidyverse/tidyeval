...
The primary goal of this book is to get you up to speed with tidy evaluation and how to write functions around tidyverse pipelines and grammars. The book is written and organised so that you can quickly find the information you need to solve concrete problems without having to "get" tidy eval first:
...
* The *Recipes* sections are organised by common tasks for the dplyr and ggplot2 packages.
